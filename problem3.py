...
def compute_z(x, m):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test3.py::test_compute_z_5pt
        --- for Windows OS ---- 
        python -m pytest -v test3.py::test_compute_z_5pt
        ---------------------------------------------------
    '''
...
def compute_L(z, y):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test3.py::test_compute_L_5pt
        --- for Windows OS ---- 
        python -m pytest -v test3.py::test_compute_L_5pt
        ---------------------------------------------------
    '''
...
def update_parameters(optimizer):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test3.py::test_update_parameters_5pt
        --- for Windows OS ---- 
        python -m pytest -v test3.py::test_update_parameters_5pt
        ---------------------------------------------------
    '''
...
def train(data_loader, alpha=0.001, n_epoch=100):
    ...
    '''  
        ...
        ---------------------------------------------------
        --- for Mac OS ---- 
        python3 -m pytest -v test3.py::test_train_5pt
        --- for Windows OS ---- 
        python -m pytest -v test3.py::test_train_5pt
        ---------------------------------------------------
    '''
...
''' 
    TEST problem 3: (20 points)
        ...
        ----------- test session starts --------------------- 
        * (5 points) test3.py::compute_z_5pt  PASSED 
        * (5 points) test3.py::compute_L_5pt  PASSED 
        * (5 points) test3.py::update_parameters_5pt  PASSED 
        * (5 points) test3.py::train_5pt  PASSED 
